...
class WayPoints_Tao {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new WayPoints_Tao(null);
  ...
  static datatype() {
    ...
    return 'route_planning/WayPoints_Tao';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new WayPoints_Tao(null);
    if (msg.X !== undefined) {
      resolved.X = msg.X;
    }
    else {
