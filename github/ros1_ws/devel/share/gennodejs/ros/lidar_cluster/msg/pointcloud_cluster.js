...
class pointcloud_cluster {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new pointcloud_cluster(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new pointcloud_cluster(null);
...
module.exports = pointcloud_cluster;
