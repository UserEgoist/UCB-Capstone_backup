...
if("TRUE" STREQUAL "TRUE")
  set(lidar_cluster_SOURCE_PREFIX /home/tao/rover_capstone/ros1_ws/src/perception/lidar_cluster)
  set(lidar_cluster_DEVEL_PREFIX /home/tao/rover_capstone/ros1_ws/devel)
  ...
  set(lidar_cluster_INSTALL_PREFIX /home/tao/rover_capstone/ros1_ws/install)
...
if(NOT "/home/tao/rover_capstone/ros1_ws/devel/include;/home/tao/rover_capstone/ros1_ws/src/perception/lidar_cluster/include " STREQUAL " ")
  set(lidar_cluster_INCLUDE_DIRS "")
  set(_include_dirs "/home/tao/rover_capstone/ros1_ws/devel/include;/home/tao/rover_capstone/ros1_ws/src/perception/lidar_cluster/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'mli <menson@berkeley.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_cluster' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tao/rover_capstone/ros1_ws/src/perception/lidar_cluster/${idir}'.  ${_report}")
    endif()
...
set(lidar_cluster_EXPORTED_TARGETS "lidar_cluster_generate_messages_cpp;lidar_cluster_generate_messages_eus;lidar_cluster_generate_messages_lisp;lidar_cluster_generate_messages_nodejs;lidar_cluster_generate_messages_py")
...
set(depends "pcl_ros;roscpp;sensor_msgs;std_msgs;tf2;message_runtime")
foreach(depend ${depends})
  ...
  list(APPEND lidar_cluster_EXPORTED_TARGETS ${${lidar_cluster_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "lidar_cluster-msg-extras.cmake")
