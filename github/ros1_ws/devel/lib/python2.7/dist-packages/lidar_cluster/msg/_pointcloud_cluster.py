...
"""autogenerated by genpy from lidar_cluster/pointcloud_cluster.msg. Do not edit."""
import codecs
import sys
...
class pointcloud_cluster(genpy.Message):
  _md5sum = "03cc5f413fedb5e9b5520c03d0e6e027"
  _type = "lidar_cluster/pointcloud_cluster"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Pointcloud Cluster Msg
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(pointcloud_cluster, self).__init__(*args, **kwds)
